...
export const HAIR_STYLES = [
  // --- 여성용 헤어스타일 (8개) ---
  {
    ...
    name: '네추럴 웨이브 펌',
    category: '여성 웨이브',
    thumbnail: '/images/styles/sample_wave_perm.png',
    resultImage: '/images/styles/sample_wave_perm.png',
    desc: '부드러운 에스컬과 풍성한 볼륨감의 고급스러운 스타일',
    promptEng: 'long voluminous wave perm hairstyle, soft S-curls cascading down the shoulders, side-swept elegant bangs, high volume'
  },
  {
    id: 'style_short_cut',
    gender: 'women',
    name: '시크 리프 숏컷',
    category: '여성 숏컷',
    thumbnail: '/images/styles/sample_short_cut.png',
    resultImage: '/images/styles/sample_short_cut.png',
  ...
  },
  {
    ...
    name: '테슬 숏 단발',
    category: '여성 단발',
    thumbnail: '/images/styles/sample_bob_cut.png',
    resultImage: '/images/styles/sample_bob_cut.png',
  ...
  },
  {
    ...
    name: '레이어드 C컬 펌',
    category: '여성 레이어드',
    thumbnail: '/images/styles/sample_layered_c.png',
    resultImage: '/images/styles/sample_layered_c.png',
  ...
  },
  {
    ...
    name: '세련된 허쉬 컷',
    category: '여성 레이어드',
    thumbnail: '/images/styles/sample_hush_cut.png',
    resultImage: '/images/styles/sample_hush_cut.png',
  ...
  },
  {
    ...
    name: '슬릭 롱 스트레이트',
    category: '여성 생머리',
    thumbnail: '/images/styles/sample_sleek_long.png',
    resultImage: '/images/styles/sample_sleek_long.png',
  ...
  },
  {
    ...
    name: '젤리 히피 펌',
    category: '여성 웨이브',
    thumbnail: '/images/styles/sample_hippie_perm.png',
    resultImage: '/images/styles/sample_hippie_perm.png',
  ...
  },
  {
    ...
    name: '에지 픽시 컷',
    category: '여성 숏컷',
    thumbnail: '/images/styles/sample_pixie_cut.png',
    resultImage: '/images/styles/sample_pixie_cut.png',
